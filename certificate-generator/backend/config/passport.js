  ...
  new GoogleStrategy(
    {
      ...
      // drive.file lets the app store templates/certificates in a folder in the user's OWN
      // Drive - it can only see/manage files it creates, never the rest of the user's Drive
      scope: [
        "profile",
        "email",
