...
require("./config/registerFonts").registerFonts(); // must run before any sharp usage
...
// Templates and certificates now stream from Google Drive via dedicated
// routes (see routes/tasks.js and routes/certificates.js) rather than
// being served as static local files.
